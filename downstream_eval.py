...
if __name__ == '__main__':
    ...
    if  not os.path.isdir(args.load_path):
        ...
        if args.downstream_task == 'fine_tune':
            print("Arguments in YAML format:")
        ...
        #  ajouté à la main 
        #args.eval = os.path.join(args.load_path, ckpt_file)
        ...
        if args.downstream_task == 'fine_tune':
            print('i am in fine tunnnnnnnnnnnnnnnnnnnnne')

...
class GradTs_2dPE(nn.Module):
    def __init__(self, in_chan, embed_dim, grid_size, add_w='mapping', cls_token=False) -> None:
        super().__init__()
...
class VisionTransformer(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.gradient_pos_embed = gradient_pos_embed
        print( " self.gradient_pos_embed.shape[-1] " , self.gradient_pos_embed.shape[-1]
              , "\n embed_dim = ", embed_dim , "\n num_patches_2d = ", self.num_patches_2d)
    ...
    def forward(self, x, masks=None, return_attention=False):
        ...
        B, N, D = x.shape
        print(' in vision transf the size of gard pos emb is ' , self.gradient_pos_embed.shape)
